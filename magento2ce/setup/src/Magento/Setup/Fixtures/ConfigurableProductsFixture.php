...
class ConfigurableProductsFixture extends Fixture
{
    ...
    protected function getRows($productCategory, $productWebsite)
    {
        return [
            [
                'sku' => 'Configurable Detail %s-option 1',
                'store_view_code' => '',
                ...
                'is_returnable' => 'no',
                'manufacturer' => '',
                'meta_description' => 'Configurable Detail %s <p>Configurable product description 1</p>',
                'meta_keyword' => 'Configurable Detail 1',
                'meta_title' => 'Configurable Detail %s',
                'minimal_price' => '',
                'msrp' => '',
                'msrp_display_actual_price_type' => 'Use config',
                'name' => 'Configurable Detail %s-option 1',
                'news_from_date' => '',
                'news_to_date' => '',
            ...
            [
                'sku' => 'Configurable Detail %s-option 2',
                'store_view_code' => '',
                'attribute_set_code' => 'Default',
                'product_type' => 'simple',
                'categories' => $productCategory,
                ...
                'msrp' => '',
                'msrp_display_actual_price_type' => 'Use config',
                'name' => 'Configurable Detail %s-option 2',
                'news_from_date' => '',
                'news_to_date' => '',
                'options_container' => 'Block after Info Column',
                'page_layout' => '',
            ...
            [
                'sku' => 'Configurable Detail %s-option 3',
                'store_view_code' => '',
                'attribute_set_code' => 'Default',
                'product_type' => 'simple',
                'categories' => $productCategory,
                ...
                'msrp' => '',
                'msrp_display_actual_price_type' => 'Use config',
                'name' => 'Configurable Detail %s-option 3',
                'news_from_date' => '',
                'news_to_date' => '',
                'options_container' => 'Block after Info Column',
                'page_layout' => '',
            ...
            [
                ...
                'is_returnable' => 'no',
                'manufacturer' => '',
                'meta_description' => 'Configurable Detail %s <p>Configurable product description %s</p>',
                'meta_keyword' => 'Configurable Detail %s',
                'meta_title' => 'Configurable Detail %s',
                'minimal_price' => '',
                'msrp' => '',
                'msrp_display_actual_price_type' => 'Use config',
                'name' => 'Configurable Detail %s',
                'news_from_date' => '',
                'news_to_date' => '',
                'options_container' => 'Block after Info Column',
                'page_layout' => '',
                ...
                '_media_position' => '',
                '_media_is_disabled' => '',
                'configurable_variations' => 'sku=Configurable Detail %s-option 1,configurable_variation=option 1|sku=Configurable Detail %s-option 2,configurable_variation=option 2|sku=Configurable Detail %s-option 3,configurable_variation=option 3',
            ],
        ];
